...
\section{Projects}
    ...
    \resumeProjectHeading
        {\textbf{Line Tracer Analog} $|$ \emph{\href{https://www.linkedin.com/in/jonathan-oktaviano/details/projects/}{\color{blue}Linkedin}}}{}
          \resumeItemListStart
            \resumeItem{I developed an Analog Line Tracer using multiple Operational Amplifier ICs, relays, and various sensor circuits for competitive use. This involved designing the entire electronic circuitry of the robot, integrating all components, and testing the sensors on the track to optimize robot control.}
          \resumeItemListEnd
          
     \resumeProjectHeading
        {\textbf{Oil Navigating Ship} $|$ \emph{\href{https://www.linkedin.com/in/jonathan-oktaviano/details/projects/}{\color{blue}LinkedIn}}}{}
          \resumeItemListStart
