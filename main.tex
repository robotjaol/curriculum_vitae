...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Technologies:}{ Flask, Streamlit, Node.js, React.js, Git, Docker, AWS, RabbitMQ, OpenCV, PyTorch, Mediapipe, TensorFlow, Arduino, ESP32, STM32, PLC Omron, PLC Mitsubishi, ROS} \\ \vspace{3pt}
...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        {\textbf{Tic Tac Toe} $|$ \emph{\href{https://github.com/robotjaol/c_game}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{Designing a tic-tac-toe game with a criterion that the bot never loses, and allowing for gameplay between two players. This time, I created it using the C language.}
          \resumeItemListEnd
      
      \resumeProjectHeading
        {\textbf{CV Webiste} $|$ \emph{\href{https://github.com/robotjaol/cv_web}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{For this project, I created a portfolio website using semantic HTML, CSS, and JS for branding purposes.}
          \resumeItemListEnd
      
      \resumeProjectHeading
        {\textbf{STM32 Training Kit} $|$ \emph{\href{https://github.com/robotjaol/STM32_Training_Kit}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{I engineered this microcontroller employing the STM32F103C8T6 IC with a tailored design, leveraging KiCAD software to craft the STM32 Training Kit for Barunastra ITS.}
          \resumeItemListEnd
          
     \resumeProjectHeading
        {\textbf{ESP32 Electric Vehicle} $|$ \emph{\href{https://github.com/robotjaol/esp32_breakout_board}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{Here I developed a custom PCB for an ESP32 microcontroller equipped with an embedded CAN bus module. This project was tailored for electric vehicle monitoring purposes.}
          \resumeItemListEnd
      ...
      \resumeProjectHeading
        {\textbf{Smart Integrated Water Quality Monitoring System} $|$ \emph{\href{https://github.com/robotjaol/kkn_project}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{This project was part of my Community Empowerment Program (KKN) focusing on thematic environmental issues. It entailed monitoring the water quality of ponds, including temperature, pH, and oxygen levels, and developing a website to store all the collected data.}
          \resumeItemListEnd

     \resumeProjectHeading
        {\textbf{Thermal CCTV HVAC} $|$ \emph{\href{https://github.com/robotjaol/thermal_CCTV_HVAC}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{In this project, I integrated two systems: an environmental thermal detection system using Thermal CCTV and an HVAC cooling system. The aim of combining these two systems is energy efficiency, achieved through automatic room cooling based on temperature readings from the Thermal CCTV. The programming languages utilized in this project include Python, C, and a website for monitoring, along with various technologies such as YOLO, Flask, and others.}
          \resumeItemListEnd
          
     \resumeProjectHeading
        {\textbf{Oil Navigating Ship} $|$ \emph{\href{https://www.linkedin.com/in/jonathan-oktaviano/C}{\color{blue}LinkedIn}}}{}
          \resumeItemListStart
            \resumeItem{In this project, I served as both an electrical and mechanical conceptor and consultant. My responsibilities included designing electrical and communication diagrams for the ship and providing recommendations for the implementation of ship maneuvers.}
          \resumeItemListEnd
